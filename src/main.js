...
function visual(scene) {
 ...
 if (kind === 'memories') return '<div class="memories-visual"><div class="route shared" data-shared="spark"></div><img class="memory memory-one" src="' + scene[5] + '" alt="Anyelo travelling"><img class="memory memory-two" src="' + scene[6] + '" alt="Anyelo skiing"><span class="stamp">MEMORIES / 02</span></div>'
 ...
 if (kind === 'hellotext') return '<div class="chat-visual"><div class="bubble coral">Hello! Can I help you?</div><div class="bubble blue shared" data-shared="spark">✦</div><div class="bot">◡</div></div>'
 ...
 if (kind === 'team') return '<div class="team-visual">' + ['design','product','engineering'].map(x => '<div class="team-node">' + icon('●',x) + '<span>' + x + '</span></div>').join('') + '<div class="team-core shared" data-shared="spark">✦</div></div>'
 if (kind === 'bridge') return '<div class="bridge-visual"><div class="person-dot"></div><div class="bridge-line shared" data-shared="spark"></div><div class="person-dot"></div><div class="bridge-label">conversation</div></div>'
